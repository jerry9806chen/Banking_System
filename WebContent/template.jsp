		...
		<div class="customNavbar">
			...
			<div class="customDropDown">
				...
				<div class="customDropDown-content">
					<a href="Customer/CreateCustomer.jsp">Create Customer</a><a href="#">Customer
						Search</a>
				</div>
			</div>
			<div class="customDropDown">
				<button type="button" id="account-management">Account
					Management</button>
				<div class="customDropDown-content">
					<a href="#">Create Account</a> <a href="#">Account Search</a>
				</div>
			</div>
			<div class="customDropDown">
				<button type="button" id="status-details">Status Details</button>
				<div class="customDropDown-content">
					<a href="#">Customer Status</a> <a href="#">Account Status</a>
				</div>
			</div>
