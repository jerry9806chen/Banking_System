...
<head>
<%
	ArrayList<Customer> customerList = (ArrayList<Customer>) request.getAttribute("searchList");
%>
<!-- Bootstrap CSS -->
<link rel="stylesheet"
...
<link rel="stylesheet" href="CustomerSearch/styles.css">
</head>
<body>
	...
	<div class="mainContent">
		...
		<div class="text-center row" style="width: 100%; min-height: 400px;">
			...
			<div class="col-md-8">
				<form id="viewCustomerForm" name="viewCustomerForm" action="UpdateNavigationController" method="get">
					<input type="hidden" id="customerId" name="customerId" value="" /><br>
					<input type="hidden" id="customerSSN" name="customerSSN" value="" /><br>
					<input type="hidden" id="formActionType" name="formActionType" value="" /><br>
					...
					<table class="table customerSearch">
						...
						<tbody>
							...
							<%
								Iterator myIterator = customerList.iterator();
								while (myIterator.hasNext()) {
									Customer customer = (Customer) myIterator.next();
							%>
							...
							<tr>
								...
								<td><a href="#" onclick="goToUpdate(<%= customer.getCustomerID() %>,<%= customer.getCustomerSSN() %>)">Update</a></td>
								<td><a href="#" onclick="goToDelete(<%= customer.getCustomerID() %>,<%= customer.getCustomerSSN() %>)">Delete</a></td>
							</tr>
...
<!-------------------------------------  Footer ------------------------------------------->
	...
	<script type="text/javascript" src="CustomerSearch/CustomerSearch.js"></script>
	<!--  Bootstrap scripts -->
