...
<body>
	...
	<div class="mainContent">
		<div class=' text-center main-content'>
			<form class="customerSearchForm" name="customerSearchForm"
				action="SearchCustomerController" method="post">
				<div class="form-group">
					<h3>Search Customer</h3>
					<table class="table table-borderless searchTable">
						<tr>
							<td><label for="ssnID">Enter SSN ID:<sup
									class="superScript">*</sup></label></td>
							<td><input type="number" class="form-control-sm"
								name="ssnID" id="ssnID" maxLength = "9" ></td>
						</tr>
						...
						<tr>
							...
							<td><input type="number" class="form-control-sm"
								...
								onchange="customerIdValidation(this.val)" ></td>
						</tr>
						<tr style="text-align: center">
							<td colspan="2"><input class="btn btn-outline-secondary"
								type="submit" id="customerSearchButton" value="VIEW"></td>
						</tr>
					</table>
				</div>
			</form>
	...
	<!--<script type="text/javascript" src="/CustomerSearch/scripts.js"></script>-->
	<!--  Bootstrap scripts -->
