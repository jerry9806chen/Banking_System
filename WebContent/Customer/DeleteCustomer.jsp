...
<main class="update-customer-table">
	...
	<form id="DeleteCustomerForm" name="DeleteCustomerForm" action="DeleteCustomerController" method="post">
		<table align="left" style="text-align:left;" class="customer-info-table" width="100%">
			...
			<tr></tr>
			<tr>
				<td class="row-label" style="text-align:left;">Customer Name </td>
				<td style="text-align:left;"><%= customer.getCustomerName() %></td>
			</tr>
			<tr></tr>
			
			<tr>
				<td class="row-label" style="text-align:left;">Address </td>
			...
			<tr>
				<td class="row-label" style="text-align:left;">Age </td>
